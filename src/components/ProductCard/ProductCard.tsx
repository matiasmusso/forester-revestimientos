      ...
      <Card>
        <ImageContainer onClick={() => setIsModalOpen(true)}>
          {mainImage ? (
            ...
            <NoImage>Sin Imagen</NoImage>
          )}

          <ImageOverlay>
            <ViewIconButton title="Ver galería">
        ...
        <CardContent>
          <ProductTitle onClick={() => setIsModalOpen(true)}>
            {product.nombre}
          </ProductTitle>
          ...
          <ViewDetailsButton onClick={() => setIsModalOpen(true)}>
            Ver Detalles
          </ViewDetailsButton>
        </CardContent>
      </Card>
        ...
        <ModalBackdrop onClick={() => setIsModalOpen(false)}>
          <ModalContent onClick={(e) => e.stopPropagation()}>
            ...
            <ModalBody>
              ...
              <ModalTextSection>
                <ModalScrollableArea>
                  <ModalTitle>{product.nombre}</ModalTitle>
                  <ModalDescription>
