    ...
    <>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm" onClick={() => setIsModalOpen(false)}>
          <div
            className="bg-white rounded-2xl max-w-5xl w-full h-[75vh] md:h-[50vh] shadow-2xl relative overflow-hidden flex flex-col"
          ...
          >
            ...
            <div className="flex flex-col md:grid md:grid-cols-2 h-full overflow-hidden">
              <div className="bg-gray-100 p-4 md:p-6 flex items-center justify-center shrink-0 border-b border-gray-200 md:border-b-0">
                {mainImage ? (
                  <>
                    {/* Mobile Image: Altura fija con cover para dejar espacio al texto */}
                    ...
                    {/* Desktop Image: Dinámico para no distorsionar */}
                    <Image
                      src={imagePath}
                      alt={product.nombre}
                      width={800}
                      height={800}
                      className="hidden md:block max-w-full w-auto h-auto max-h-[42vh] rounded-xl shadow-md"
                    />
                  </>
                ) : (
                  <div className="w-full aspect-[4/3] flex items-center justify-center text-gray-400 bg-white rounded-xl shadow-sm">Sin Imagen</div>
                )}
              </div>
              ...
              <div className="flex-1 flex flex-col h-full overflow-hidden">
                ...
                <div className="p-6 md:p-8 flex-1 overflow-y-auto">
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6 font-work-sans pr-8">{product.nombre}</h2>
                ...
                <div className="p-4 md:p-6 border-t border-gray-100 bg-white shrink-0">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-center w-full gap-2 bg-[#25D366] text-white px-6 py-3 md:py-4 rounded-xl font-bold hover:bg-[#128C7E] transition-colors shadow-lg text-base md:text-lg"
                  >
